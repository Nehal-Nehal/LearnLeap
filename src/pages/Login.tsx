  ...
  const handleGoogleSignIn = async () => {
    try {
      ...
      toast({
        ...
        description: "Welcome to LearnLeap.",
        variant: "default"
      });
    } catch (error) {
        ...
        <div className="w-full max-w-md p-8 bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl">
          ...
          <div className="space-y-4">
            <button
              ...
              disabled={signingIn}
              className="relative w-full flex items-center justify-center gap-3 bg-white hover:bg-gray-50 text-black py-3 px-4 rounded-lg border border-gray-300 transition-colors disabled:opacity-70"
            >
              {signingIn ? (
